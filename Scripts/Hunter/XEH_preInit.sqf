...
[_strider,getPosATL _gun, "OEC_Ammo_Hunter_Flechette", _enemy, getPosASLVisual _enemy, 450, false, [0,0,0]] spawn WBK_fnc_ProjectileCreate_Hunter_Synth;
_gun spawn {
...
uiSleep 0.12;
_gun = _guns select 0;
[_strider,getPosATL _gun, "OEC_Ammo_Hunter_Flechette", _enemy, aimPos _enemy, 450, false, [0,0,0]] spawn WBK_fnc_ProjectileCreate_Hunter_Synth;
_gun spawn {
[_this, "WBK_hunter_fire",350] call CBA_fnc_GlobalSay3D;
_this hideObject false;
[_this, false] remoteExec ["hideObject", 0]; 
...
_gun = _guns select 0;
[_strider, selectRandom ["WBK_hunter_foundenemy1","WBK_hunter_foundenemy2","WBK_hunter_foundenemy3"], 35, 3] execVM "\WebKnight_StarWars_Mechanic\createSoundGlobal.sqf"; 
[_strider,getPosASL _gun, "OEC_Ammo_Hunter_Flechette", _enemy, getPosASLVisual _enemy, 550, false, [0,0,0]] spawn WBK_fnc_ProjectileCreate_Hunter_Synth;
_gun spawn {
[_this, "WBK_hunter_fire",350] call CBA_fnc_GlobalSay3D;
_this hideObject false;
[_this, false] remoteExec ["hideObject", 0]; 
...
_enemy call WBK_CalculatePlayerCameraCrosshair;
_gun = _guns select 0;
[_strider,getPosASL _gun, "OEC_Ammo_Hunter_Flechette", _enemy, aimPos _enemy, 550, false, [0,0,0]] spawn WBK_fnc_ProjectileCreate_Hunter_Synth;
_gun spawn {
[_this, "WBK_hunter_fire",350] call CBA_fnc_GlobalSay3D;
_this hideObject false;
[_this, false] remoteExec ["hideObject", 0]; 
